...
Try running a script by opening `script.py` in the editor and clicking the triangular `Run Python files` button in the top right corner. You should see a simple message printed in the CLI.
